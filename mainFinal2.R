setwd("C:/Users/nvarshney/Desktop/CapstoneCourseProject Final 2")
...
# Sample data to simplify computations.
...
saveRDS(corpus, file = "./finalCorpus3.RData")
finalCorpusMem <- readRDS("./finalCorpus3.RData")
...
write.csv(unigram[unigram$freq > 1,],"unigram3.csv",row.names=F)
unigram <- read.csv("unigram3.csv",stringsAsFactors = F)
saveRDS(unigram, file = "unigram3.RData")
...
View(bigram[1:20,])
write.csv(bigram[bigram$freq > 1,],"bigram3.csv",row.names=F)
bigram <- read.csv("bigram3.csv",stringsAsFactors = F)
saveRDS(bigram,"bigram3.RData")
...
View(trigram[1:20,])
write.csv(trigram[trigram$freq>1,], "trigram3.csv", row.names = FALSE)
trigram<- read.csv("trigram3.csv", stringsAsFactors = FALSE)
saveRDS(trigram, "trigram3.RData")
...
View(quadgram[1:20,])
write.csv(quadgram[quadgram$freq > 1,], "quadgram3.csv", row.names = FALSE)
quadgram <- read.csv("quadgram3.csv", stringsAsFactors = FALSE)
saveRDS(quadgram, "quadgram3.RData")
